...
import com.lygzbkj.elemonitor.data.DeviceCategory;
...
import com.lygzbkj.elemonitor.data.cable.EleCable;
import com.lygzbkj.elemonitor.data.cable.Phase;
import com.lygzbkj.elemonitor.data.webdata.DeviceTreeNode;
import com.lygzbkj.elemonitor.service.PlaceService;
...
//				substation = substationService.findBySubstationId(substation.getId());
			...
			if(substation.getListMsgManager().isEmpty()) {
...
//	}
	...
	public String delPlace(@PathVariable long placeId) {
		Place p = placeService.findById(placeId);
		Substation substation = p.getSubstation();
